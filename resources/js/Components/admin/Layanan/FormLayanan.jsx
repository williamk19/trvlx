...
const FormLayanan = ({
  ...
  const { data, setData, post, processing, errors, reset, put } = useForm({
    ...
    kota_tujuan:
      itemLayanan?.kota_tujuan.length > 0 ? itemLayanan.kota_tujuan : "",
  ...
  const handleDelete = (e) => {
    e.preventDefault();
    router.delete(route("layanan.destroy", itemLayanan.id_layanan));
  };
            ...
            <div className="flex justify-between">
              {itemLayanan ? (
                <button
                  ...
                  data-theme="light"
                  className="btn btn-error hover:border-slate-300 hidden"
                >
                  Hapus Layanan
                </button>
              ) : (
              ...
              <button
                ...
                className={`btn ${
                  processing && "loading"
                } bg-indigo-500 border-slate-200 hover:border-slate-300 text-white hover:bg-indigo-600 disabled:text-black`}
              >
