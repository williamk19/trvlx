...
const DataItem = ({ tanggalPemberangkatan, kotaAsal, kotaTujuan }) => {
  return (
    <div>
      <ul className="my-1">
          ...
          <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
            <div className="grow flex justify-between">
              ...
              <div className="text-base shrink-0 self-end ml-2 flex items-center justify-center gap-1">
                <Link className="font-semibold flex items-center justify-center gap-1 text-indigo-500 text-sm md:text-base hover:text-indigo-600" href="/">
