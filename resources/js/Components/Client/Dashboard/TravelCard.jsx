    ...
    <div className="col-span-full sm:col-span-6 xl:col-span-4 from-emerald-200 bg-white shadow-md rounded-xl border border-gray-400">
      <div className="flex flex-col h-full p-5">
        <div className="grow mt-2">
          <Link className="inline-flex text-slate-800 hover:text-slate-900 mb-1" href={`/client/order/${id}`}>
        ...
        <footer className="mt-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <div>
              <Link className="text-sm flex items-center gap-1.5 font-medium text-indigo-500 hover:text-indigo-600" href={`/client/order/${id}`}>
