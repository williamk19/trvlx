      ...
      <div className="max-w-6xl w-11/12 mt-24 md:mt-30 sm:mt-24 lg:mt-32">
        <div className="hero-content flex-col gap-x-24 p-0 lg:flex-row-reverse">
          <div className="text-center lg:text-left">
            <h1 className="text-3xl md:text-5xl font-bold text-white">Sewa Mobil Hiace, Elf, Bus, Tour Travel Wisata Jawa Bali
            </h1>
            <p className="py-6 text-sm md:text-lg text-white">Dengan Armada Transportasi yang Sehat, Bersih, Harum, pelayanan yang maksimal dan didukung oleh Driver Ramah Profesional serta Customer Service yang fast respon selama 24 jam akan membuat Anda semakin nyaman di perjalanan.</p>
          </div>
